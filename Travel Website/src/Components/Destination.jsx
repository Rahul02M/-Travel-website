...
const Destination = () => {
  return (
    <div className="min-h-screen flex flex-col justify-center md:mx-32 mx-5">
      <h1 className="font-semibold  text-center text-4xl lg:mt-0 mt-17">
      ...
      <div className="flex flex-col lg:flex-row gap-5 mt-14 ">
        ...
        <DestinationCard
          img={img3}
          title="Venice, Italy"
          para="Explore the romantic canals and historis architecture of Venice, a city built on water."
        />
      </div>
    </div>
  );
